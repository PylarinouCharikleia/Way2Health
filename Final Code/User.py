...
class User:
	...
	def codeMessage(self, message, receiver, title, urgency):
		mes = Message(self,receiver, '', title, urgency)
		result = []
...
class Doctor(User):
	...
	def selectReceiver(self):
		found = 0
		print("=====================Doctor Inbox=====================")#header
		User.printEmptyLines(2)
		print("|The Available Patients are:                         |")
		User.printEmptyLines(1)
		print("|     Surname:                Name:                  |")
...
class Patient(User):
	...
	def insert_medical_report(self):
		...
		print("===================Exam Insertion=====================")#header
		User.printEmptyLines(3)
		
		print ("|    Insert the type of exam you want to insert:     |")
		print ("|     1.metabolism, 2.heart, 3.urinary, 4.liver      |")
		print ("|   5.vitamins, 6.thyroid, 7.immune, 8.generalBlood  |")
		print ("|      (thyroid and heart only available now!)       |")
		User.printEmptyLines(3)
		...
		while (type != "metabolism" and type != "heart" and type != "urinary" and type != "liver" and type != "vitamins" and type != "thyroid" and type != "immune" and type != "generalblood"):
			...
			print ("|         Please enter correct type of exam!         |")
